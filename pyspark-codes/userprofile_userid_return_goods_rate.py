...
Date: 2018/10/01
submit command: 
spark-submit --master yarn --deploy-mode client --driver-memory 4g  --executor-memory 8g --executor-cores 2 --num-executors 100 userprofile_userid_return_goods_rate.py start-date
"""
